...
output "keepa_raw_prefix" {
  description = "S3 prefix for Keepa raw JSONL"
  value       = "s3://${aws_s3_bucket.data.bucket}/keepa/raw/"
}

output "keepa_curated_prefix" {
  description = "S3 prefix for Keepa curated"
  value       = "s3://${aws_s3_bucket.data.bucket}/keepa/curated/"
}

output "keepa_mart_prefix" {
  description = "S3 prefix for Keepa mart"
  value       = "s3://${aws_s3_bucket.data.bucket}/keepa/mart/"
}
